...
@export var size: Vector2 = Vector2(ProjectSettings.get_setting("display/window/size/viewport_width") * 1.1, ProjectSettings.get_setting("display/window/size/viewport_height") * 1.1):
	set(value):
...
@export_custom(PROPERTY_HINT_LINK, "camera_zoom") var camera_zoom: Vector2 = Vector2(0.9, 0.9)
