@icon("res://assets/misc/tools/icons/trigger2d_icon.png")
class_name Trigger2D extends Area2D
## An [code]Area2D[/code] which responds to the presence of other areas/bodies.
...
func _on_body_exited(_area: Node2D) -> void:
