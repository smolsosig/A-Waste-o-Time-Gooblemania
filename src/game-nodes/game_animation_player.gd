...
## Autoplay [member autoplay_anim_when_spawn] when [code]Staglobals.current_spawn[/code] matches [member autoplay_when_spawn_num].[br][br]
...
## Autoplays the, erh, autoplay animation at a random time.
